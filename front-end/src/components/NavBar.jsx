    ...
    <div className='fixed top-0 left-0 w-full z-10 shadow-xl'>
        ...
        <div className="navbar-center">
            <a className="btn btn-ghost text-xl">
                <Link to={'/'}>
                 <Hamburger className='size-10 text-orange-400 font-semibold' />
                </Link>
            </a>
        </div>
        <div className="navbar-end">
            ...
            <button onClick={()=> setShowForm((prev) => !prev)} className="btn btn-ghost btn-circle">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
                fill="none"
            ...
            <label className="swap swap-rotate text-center">
                ...
                <input type="checkbox" className="theme-controller" value="synthwave" onClick={handleTheme} />
